...
public class MainWindow {
	...
	private Text[] textTab = new Text[1];
	...
	protected void createContents() {
	    ...
	    comboInsert.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent arg0) {
				...
				case "ISSUE" :
					listAttributes = new String[]{"ID", "Issue_number", "Indicia_publisher_id", "Publication_date", "Price", "Page_count", "Indicia_frequency",
												"Editing", "Notes", "ISBN", "Valid_ISBN", "Barcode", "Title", "On_sale_date", "Rating", "Series_id"};
					break;
				...
				case "SERIES" :
					listAttributes = new String[]{"ID", "Name", "Format", "Publication_dates", "Year_began", "Year_ended", "First_issue_id", "Last_issue_id",
												"Publisher_id", "Country_id", "Language_id", "Notes", "Color", "Dimensions", "Paper_stock", "Binding", "Publishing_format", "Publication_type"};
					break;
					
				case "STORY" :
					listAttributes = new String[]{"ID", "Title", "Issue_id", "Synopsis", "Reprint_notes", "Notes", "Type_id"};
					break;
